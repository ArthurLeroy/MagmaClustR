...
# NeurIPS : Phase 1 — Entraînement MOMT pour les 10 configs × 2 problèmes
#
# 10 configs (7 anciennes + 3 variations n_clust) × 2 problèmes × 50 seeds
# = 1000 jobs répartis sur 16 cœurs via file d'attente.
#
# Configs : on fait varier une variable d'intérêt à la fois, les autres
#           restent à leur valeur par défaut (n_out=2, n_train=30, n_pred=1, n_clust=1).
#
...
echo "=============================================="
echo " NeurIPS Phase 1 : MOMT (10 configs × 2 problèmes × ${N_SEEDS} seeds)"
echo " Date    : $(date)"
echo " Noeud   : $(hostname)"
...
# Les 10 configurations uniques (n_out, n_train, n_pred, n_clust)
# On fait varier une variable à la fois ; défaut = (2, 30, 1, 1).
# Priorité : gros n_out > gros n_train > gros n_clust > gros n_pred.
declare -a CONFIGS=(
  "4 30 1 1"
  "8 30 1 1"
  "2 30 1 1"
