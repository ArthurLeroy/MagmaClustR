#!/bin/bash -l
#===============================================================================
# job_NeurIPS_nclust_phase2_MT.sh
# NeurIPS : Phase 2 — MT pour les 10 configs × 2 problèmes
#
# Pré-requis : les données MOMT doivent être présentes (Phase 1 terminée).
#
# MT : 10 configs × 2 problèmes × 50 seeds = 1000 jobs
#
# Soumission : sbatch job_NeurIPS_nclust_phase2_MT.sh
#===============================================================================

#SBATCH --job-name=neurips_nclust_mt
#SBATCH --qos=huge
#SBATCH -c 16
#SBATCH --time=7-00:00:00
#SBATCH --output=/scratch/%u/logs/neurips_nclust_mt_%j.out
#SBATCH --error=/scratch/%u/logs/neurips_nclust_mt_%j.err
...
echo "=============================================="
echo " NeurIPS Phase 2 : MT (10 configs)"
echo " Date    : $(date)"
echo " Noeud   : $(hostname)"
...
# --- Logs ---
LOGDIR="/scratch/${USER}/logs/neurips_nclust_mt"
mkdir -p "${LOGDIR}"
...
JOBFILE="/scratch/${USER}/logs/neurips_nclust_mt/jobqueue_${SLURM_JOB_ID}.txt"
COUNTERFILE="/scratch/${USER}/logs/neurips_nclust_mt/counter_${SLURM_JOB_ID}"
...
echo ""
echo "=============================================="
echo " NeurIPS Phase 2 MT TERMINÉE"
echo " Date       : $(date)"
...
echo "Vérification OK : toutes les prédictions MT sont présentes."
exit 0