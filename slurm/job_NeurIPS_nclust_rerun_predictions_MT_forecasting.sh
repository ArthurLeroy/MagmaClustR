#!/bin/bash -l
#===============================================================================
# job_NeurIPS_nclust_rerun_predictions_MT_forecasting.sh
# NeurIPS : relance uniquement les prédictions MT forecasting.
#
# 10 configs x 50 seeds = 500 jobs
#
# Soumission : sbatch job_NeurIPS_nclust_rerun_predictions_MT_forecasting.sh
#===============================================================================

#SBATCH --job-name=rerun_mt_fcst
#SBATCH --qos=huge
#SBATCH -c 25
#SBATCH --time=7-00:00:00
#SBATCH --output=/scratch/%u/logs/rerun_mt_fcst_%j.out
#SBATCH --error=/scratch/%u/logs/rerun_mt_fcst_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=alexia.grenouillat@math.univ-toulouse.fr

N_WORKERS=25
N_SEEDS=50
PROJECT_ROOT="/scratch/${USER}/NeurIPS_experiments_forecasting"
SCRIPT_DIR="${PROJECT_ROOT}/scripts"
SCRIPT_NAME="Rerun_Predictions_NeurIPS_MT_nclust_forecasting.R"
RESULTS_DIR="${PROJECT_ROOT}/Predictions_MT"
LOGDIR="/scratch/${USER}/logs/rerun_mt_fcst"

echo "=============================================="
echo " RERUN MT FORECASTING"
echo " Date    : $(date)"
echo " Noeud   : $(hostname)"
...
worker() {
  ...
  while true; do
    ...
    LABEL="mt_fcst_out${N_OUT}_train${N_TRAIN}_pred${N_PRED}_clust${N_CLUST}_seed${SEED}"
