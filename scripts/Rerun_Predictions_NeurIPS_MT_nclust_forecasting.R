# ==========================================================================
# Rerun_Predictions_NeurIPS_MT_nclust_forecasting.R
...
#
# Usage :
#   Rscript Rerun_Predictions_NeurIPS_MT_nclust_forecasting.R \
...
run_info <- list(
  script = "Rerun_Predictions_NeurIPS_MT_nclust_forecasting.R",
  n_out = N_OUT,
  n_train = N_TRAIN,
  n_pred = N_PRED,
  n_clust = N_CLUST,
