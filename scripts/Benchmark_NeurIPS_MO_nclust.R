# ==========================================================================
# Benchmark_NeurIPS_MO_nclust.R
# NeurIPS : Benchmark MO avec paramètre n_clust variable (1, 2, 3, 4)
#
# Usage :
#   Rscript Benchmark_NeurIPS_MO_nclust.R --n_out=2 --n_train=30 --n_pred=1 \
#     --n_clust=1 --problem=interpolation --seed=1
#
# Charge les données scalées générées par MOMT_nclust.
...
run_info <- list(
  script = "Benchmark_NeurIPS_MO_nclust.R",
...
tryCatch({
  ...
  # 3d. Grid inputs pour la prédiction
