...
test_that("gradient of gr_GP_mod_common_hp_k() works", {
  ...
  deriv_v = gr_GP_mod_common_hp_k(hp, db, mean, 'SE', new_cov, 0.1)[['variance']]
  deriv_l = gr_GP_mod_common_hp_k(hp, db, mean, 'SE', new_cov, 0)[['lengthscale']]

  emp_deriv_v = (logL_GP_mod_common_hp_k(hp_v, db, mean, 'SE', new_cov, 0.1) -
                   logL_GP_mod_common_hp_k(hp, db, mean, 'SE', new_cov, 0.1)) / 10^(-8)

  emp_deriv_l = (logL_GP_mod_common_hp_k(hp_l, db, mean, 'SE', new_cov, 0) -
                   logL_GP_mod_common_hp_k(hp, db, mean, 'SE', new_cov, 0)) / 10^(-8)
...
test_that("gradient of gr_clust_multi_GP_common_hp_i() works", {
  ...
  deriv_v = gr_clust_multi_GP_common_hp_i(hp_i_1, db_1, mu_k_param, 'SE', 0)[['variance']]
  deriv_l = gr_clust_multi_GP_common_hp_i(hp_i_1, db_1, mu_k_param, 'SE', 0)[['lengthscale']]

  emp_deriv_v = (logL_clust_multi_GP_common_hp_i(hp_v, db_1, mu_k_param, 'SE', 0) -
                   logL_clust_multi_GP_common_hp_i(hp_i_1, db_1, mu_k_param, 'SE', 0)) / 10^(-8)
  emp_deriv_l = (logL_clust_multi_GP_common_hp_i(hp_l, db_1, mu_k_param, 'SE', 0) -
                   logL_clust_multi_GP_common_hp_i(hp_i_1, db_1, mu_k_param, 'SE', 0)) / 10^(-8)
