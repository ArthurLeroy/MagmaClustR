#!/bin/bash -l
#===============================================================================
# job_phase1_nc_probleme.sh — Phase 1 NC : Paramètre "probleme"
#
# Phase 1 : 10 MOMT NC (5 seeds × 2 configs)
# Phase 2a: 10 MT NC  (5 seeds × 2 configs)
# Phase 2b: 10 MO NC  (5 seeds × 2 configs)
#
# Soumission : sbatch job_phase1_nc_probleme.sh
#===============================================================================

#SBATCH --job-name=p1nc_prob
#SBATCH --qos=huge
#SBATCH -c 20
#SBATCH --time=3-00:00:00
#SBATCH --output=/scratch/%u/logs/phase1_nc_probleme_%j.out
#SBATCH --error=/scratch/%u/logs/phase1_nc_probleme_%j.err
