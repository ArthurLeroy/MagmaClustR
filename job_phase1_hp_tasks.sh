#!/bin/bash -l
#===============================================================================
# job_phase1_hp_tasks.sh — Phase 1 : Paramètre "hp_tasks" (shared vs distincts)
#
# Phase 1 : 20 MOMT (5 seeds × 2 configs)
# Phase 2a: 20 MT   (5 seeds × 2 configs)
# Phase 2b: 20 MO   (5 seeds × 2 configs)
#
# Soumission : sbatch job_phase1_hp_tasks.sh
#===============================================================================

#SBATCH --job-name=p1_hp_tasks
#SBATCH --qos=huge
#SBATCH -c 20
#SBATCH --time=3-00:00:00
#SBATCH --output=/scratch/%u/logs/phase1_hp_tasks_%j.out
#SBATCH --error=/scratch/%u/logs/phase1_hp_tasks_%j.err
