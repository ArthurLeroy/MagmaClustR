#!/bin/bash -l
#===============================================================================
# job_phase1_nc_hp_clusters.sh — Phase 1 NC : Paramètre "hp_clusters"
#
# Note : Sans clustering, ce paramètre n'a pas d'effet sur la génération
# de données ni sur l'entraînement. Les deux configs (default/variation)
# produisent les mêmes réglages. Ce job est conservé pour cohérence avec
...
#
# Soumission : sbatch job_phase1_nc_hp_clusters.sh
#===============================================================================

#SBATCH --job-name=p1nc_hpcl
#SBATCH --qos=huge
#SBATCH -c 20
#SBATCH --time=3-00:00:00
#SBATCH --output=/scratch/%u/logs/phase1_nc_hp_clusters_%j.out
#SBATCH --error=/scratch/%u/logs/phase1_nc_hp_clusters_%j.err
