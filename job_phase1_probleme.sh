#!/bin/bash -l
#===============================================================================
# job_phase1_probleme.sh — Phase 1 : Paramètre "problème" (interpolation vs forecasting)
#
# Phase 1 : 20 MOMT (10 seeds × 2 configs)
# Phase 2a: 20 MT   (10 seeds × 2 configs)
# Phase 2b: 20 MO   (10 seeds × 2 configs)
#
# Soumission : sbatch job_phase1_probleme.sh
#===============================================================================

#SBATCH --job-name=p1_probleme
#SBATCH --qos=huge
#SBATCH -c 20
#SBATCH --time=3-00:00:00
#SBATCH --output=/scratch/%u/logs/phase1_probleme_%j.out
#SBATCH --error=/scratch/%u/logs/phase1_probleme_%j.err
...
# --- Vérification : les datasets MOMT existent ? ---
